...
const Featured = () => {
    ...
    <Link to="/Featured"><h6><a href="google.com">View More</a> <i className='fa fa-arrow-right circle rounded-circle p-1' style={{color:"white", backgroundColor:"rgba(0, 52, 82,1)"}}></i></h6></Link>
    </div>
</div>
</section>
     </>
